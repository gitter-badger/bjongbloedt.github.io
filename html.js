...
module.exports = React.createClass({
    ...
    render() {
        ...
        const favicon = <link rel="icon" type="image/png" href={require('./pages/favicon-16x16.png')} />
        let css = <style dangerouslySetInnerHTML={ {    __html: require('!raw!./public/styles.css')} } />
